        ...
        <div class="x_content">
          ...
          <form class="form-horizontal form-label-left" novalidate action="" method="POST">
           ...
           {{--  <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" name="jurusan_id">
                  @foreach ($element->jurusans as $kol)
            ...
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Konseptrasi</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" name="kelas_bagian_id">
                  @foreach (App\KelasBagian::all() as $gor)
                  <option value="{{ $gor->id }}">{{ $gor->konsentrasi }} {{ $gor->kelas_bagian }}</option>
                  @endforeach
                </select>
              </div>
            </div> --}}
           {{--  <div class="item form-group">
            ...
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Pelajaran <span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input id="name" class="form-control col-md-8 col-xs-12" name="kategori_pelajaran_id" value="" required="required" type="hidden">
            <div class="form-group">
